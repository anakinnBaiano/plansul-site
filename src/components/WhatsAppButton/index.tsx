...
export default function WhatsAppButton() {
  return (
    <a
      ...
      className="whatsapp-fab fixed bottom-24 right-6 z-50 inline-flex h-16 w-16 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg transition-transform hover:scale-105 hover:bg-[#1ebe57]"
    >
